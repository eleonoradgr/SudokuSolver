...
int main(int argc, char* argv[]){
    ...
    std::string filename("../SudokuSolver/tests/prova.txt");
    ...
    if (file.is_open()) {
        ...
        while (std::getline(file, line)) {
            ...
            {
                utimer time("parallel solution", &parallel_ff);
                parallel_ff_solve(sudoku);
            }
            std::cout << "------------------"<<std::endl;
            Sudoku::print(sudoku.starting_conf);
            std::cout << "------------------"<<std::endl;
        ...
        std::cout << parallel_ff << std::endl;
        std::cout << seq << std::endl;
        std::cout << parallel_pt << std::endl;
    } else {
